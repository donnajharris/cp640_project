...
# write processed TAIL to a saved file
print(">>> GOING TO WRITE IT BACK NOW...\n\n")
processed_filename = "./data/generated_tail.csv"
dataframe_to_CSV(cleaned, processed_filename)

print(">>> NOW, GOING TO CHECK THE SAVED FILE...")
test_it = processed_filename
df_test = CSV_to_dataframe(pd, test_it)
print(df_test)
